...
def train(Dataset, Network, Backbone):
    ## dataset
    cfg    = Dataset.Config(datapath='/home/ipal/datasets/VT5000_train', savepath='./models', mode='train', batch=32, lr=0.05, momen=0.9, decay=5e-4, epoch=32)
    ...
    for epoch in range(cfg.epoch):
        ...
        if (epoch + 1) % 32 == 0:
            ...
            if Backbone == 'res50':
                ...
                torch.save(net.state_dict(), cfg.savepath+'/SGNet_vgg16_single.' + str(epoch+1) + '.pth')
